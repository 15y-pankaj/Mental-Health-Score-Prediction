(() => {
  ...
  const API_BASE = "https://mental-health-score-prediction-1-fftv.onrender.com";
  ...
  form.addEventListener("submit", async (e) => {
    ...
    try {
      ...
      renderError(
        ...
        `Couldn't connect to ${API_BASE}. Make sure the backend is running (uvicorn app:app --reload) and reachable from this page.`
      );
    } finally {
      setSubmitting(false);
    }
